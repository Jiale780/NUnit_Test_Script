...
namespace My1stAutomationScript
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IWebElement deleteButton = testDriver.FindElement(By.XPath("//*[@id='tmsGrid']/div[3]/table/tbody/tr/td[last()]/a[2]"));
            deleteButton.Click();
            Thread.Sleep(5000);
            ...
            IWebElement timeRecord2 = testDriver.FindElement(By.XPath("//*[@id='tmsGrid']/div[3]/table/tbody/tr[last()]/td[1]"));
